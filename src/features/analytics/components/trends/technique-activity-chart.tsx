...
export function TechniqueActivityChart({ data }: Props) {
    ...
    <Card ref={cardRef}>
      <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <CardDescription>Counted by technique execution end time.</CardDescription>
        </div>
        <ExportToPngButton targetRef={cardRef} fileName="trends-technique-activity" />
      </CardHeader>
      <CardContent>
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={data}>
            ...
            <Bar dataKey="techniques" name="Techniques" fill="var(--color-accent)" />
          </BarChart>
        </ResponsiveContainer>
      </CardContent>
    </Card>
